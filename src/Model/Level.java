...
public class Level {
    ...
    private static ArrayList<Integer>[] time_small_npc, time_med_npc, time_big_npc; // time_small_npc[i][j] is the number of small npcs that appear on time j in the i-th wave
    ...
    public static Level get_instance(int num_waves, int[] health_small_npc, int[] speed_small_npc, int[] health_med_npc, int[] speed_med_npc, int[] health_big_npc, int[] speed_big_npc, ArrayList<Integer>[] time_small_npc, ArrayList<Integer>[] time_med_npc, ArrayList<Integer>[] time_big_npc){
