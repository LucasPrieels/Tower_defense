...
public class Level {
    ...
    private Level(int num_waves, int[] health_small_npc, int[] speed_small_npc, int[] health_med_npc, int[] speed_med_npc, int[] health_big_npc, int[] speed_big_npc, ArrayList<ArrayList<Integer>> time_small_npc, ArrayList<ArrayList<Integer>> time_med_npc, ArrayList<ArrayList<Integer>> time_big_npc){
    ...
    public static Level get_instance(int num_waves, int[] health_small_npc, int[] speed_small_npc, int[] health_med_npc, int[] speed_med_npc, int[] health_big_npc, int[] speed_big_npc, ArrayList<ArrayList<Integer>> time_small_npc, ArrayList<ArrayList<Integer>> time_med_npc, ArrayList<ArrayList<Integer>> time_big_npc){
